...
<form action= "register.php" method="post">
    <div class="forms ones" action = "register.php" method = "post">
        <div class="title">
            <p class="title_form">Регистрация</p>
            <hr class="line_register">
            <img src="img/image.png" alt="" class="image_registers">
        </div>
        <div class="Data">
            <div class="name">
                <p class="user_information">Введите имя</p>
                <input name = "Names"  class="input_information" type = "text" size = "15" maxlength = "15">
            </div>
            <div class="name">
                <p class="user_information">Ваша Фамилия</p>
                <input name = "Surname"  class="input_information" type = "text" size = "15" maxlength = "15">
            </div>
        </div>
        <div class="Data">
            <div class="name">
                <p class="user_information">Введите отчество</p>
                <input name = "Patronymic"  class="input_information" type = "text" size = "15" maxlength = "15">
            </div>
            <div class="name">
                <p class="user_information">Ваша номер телефона</p>
                <input name = "Tele"  class="input_information" type = "text" size = "15" maxlength = "15">
            </div>
        </div>
        <div class="Data">
        <div class="Email">
            <p class="user_information">Ваш Email</p>
 <input name = "Logins" class="input_information" required type="email" size = "15" maxlength ="15">
        </div>
            <div class="name">
                <p class="user_information">Придумайте пароль</p>
                <input name = "Pass"  class="input_information" type = "password" size = "15" maxlength = "15">
            </div>
        </div>
        ...
        <div class="account_creation">
            <button class="registration_reference" name="submit">
                <a href="../reports_page/report-panel.html" class="reference_registration">
                    <p type = "submit" name = "submit"  class="text_reference">Зарегистрироваться</p>
                </a>
            </button>
        </div>
    </div>
