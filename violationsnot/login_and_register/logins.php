...
<header>
        <div class='h-header'>
          <div class='header-content'>
            <button class ='logo' href="../components/index.php"> Нарушениям.Нет</button>
            <?php
...
<form action= "login.php" method="post">
    <div class="forms two" action = "login.php" method = "post">
        <div class="title">
            <p class="title_form">Вход в личный кабинет</p>
            <hr class="line_register">
            <img src="img/image.png" alt="" class="image_register">
        </div>
        <div class="enter_data">
                <p class="user_information">Введите Email</p>
  <input name = "Logins" class="input_enter_data" required type="email" size = "15" maxlength ="15">
                <p class="user_information">Введите пароль</p>
    <input name = "Pass"  class="input_enter_data" type = "password" size = "15" maxlength = "15">
        </div>
        ...
        <div class="account_creation">
            <button class="login_reference" name="submit">
                <a href="../reports_page/report-panel.html" class="reference_registration">
                    <p type = "submit" name = "submit" class="text_reference">Войти</p>
                </a>
            </button>
        </div>
    </div>
