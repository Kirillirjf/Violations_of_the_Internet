...
<header>
      ...
      if (empty($_SESSION['Logins']) or empty($_SESSION['id'])) {
        ?>
            <ul class='nav'>
              <li>
                <a class ='button' href="../Application-formation-page/Application-formation-page.php" target="_blank" rel="">
                  <button class ='button'>Написать заявление</button>
                </a>
              </li>
              <li class ='SignUp'>
    ...
    <div class="container">
      ...
      <table class="table">
        ...
        <tr>
          ...
          <td class="table-text">Шилин</td>
          <td class="table-text">Романович</td>
          <td class="table-text">Папал в аварию врезавшись в бордюр</td>
          <td class="table-text">к-958-ек</td>
          <td class="table-text"> <label for="state"></label>
            <select name="state" id="state" >
            <option value="awaiting" selected>В ожидании</option>
          </select></td>
        </tr>
          ...
          <td class="table-text">Шилин</td>
          <td class="table-text">Романович</td>
          <td class="table-text">Штраф за превышении скорости</td>
          <td class="table-text">к-958-ек</td>
          <td class="table-text"> <label for="state"></label>
            <select name="state" id="state" >
          ...
          <td class="table-text">Максим</td>
          <td class="table-text">Шилин</td>
          <td class="table-text">Романович</td>
          <td class="table-text">Был не пристегнутым</td>
          <td class="table-text">к-958-ек</td>
          <td class="table-text"> <label for="state"></label>
            <select name="state" id="state" >
            <option value="awaiting" selected>В ожидании</option>
